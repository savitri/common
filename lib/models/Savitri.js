...
var Section = (function (_super) {
    ...
    Section.getSectionsURL = function (book, canto, section, year) {
        return ("/savitri/books/" + book + "/cantos/" + canto + "/sections/" + section) + (year ? "?edition=" + year : "");
    };
...
var Sentence = (function (_super) {
    ...
    Sentence.getSectionsURL = function (book, canto, section, sentence, year) {
        return ("/savitri/books/" + book + "/cantos/" + canto + "/sections/" + section + "/sentences/" + sentence) + (year ? "?edition=" + year : "");
    };
